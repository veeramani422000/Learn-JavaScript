...
// ====PUSH==== add elament to the end of array

// let newPushNum = arr.push(6); //Return a lenght of array.
...
// let newUnshiftNum = arr.unshift(6); //Return a lenght of array.
...
// let newSlpiceNum = arr.splice(1,2,6,7); //returen a delete array value
// console.log(newSlpiceNum);//o/p-[2,3]

// console.log(arr);

// let newSlpiceStr = strArr.splice(2,0,"is hero");
// console.log(newSlpiceStr);//o/p-['veera','mani','is hero',karma','selva','ganesh'];
