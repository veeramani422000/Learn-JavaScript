                                                           //JAVASCRIPT
      /*Javascript is dynamic programming language that's used for web developmet,in web application,for game development,and lots more.
    ...
    It is considered best practice to always write a semicolon after a statement,it reduces the chances of bugs getting into the code.*/
                      ...
                      Primitive Data Type                                              Non-primitive Data Type OR (Reference Type)                          
                        1.String - "Any Text"                                                        1.Object - {key:'vaalue'}
                        2.Number/Integer - 123.45                                                    2.Array - [1,"Text",False]
                        3.Boolean - True or False                                                    3.Function - function name() {}
                        4.Undefinded - Undefinded
                        5.Null - Null
...
/*                                                      DECLARATIONS(86 -182)
                            ...
                            const - declares a block-scoped,read-only named connstand. */
...
//Alert - its show a message and waits for the user to press "ok". 
//alert("hello javascript"); 

//Prompt - Its shows a modal window with a test message, an input field for the  visitor,and the buttons ok/cancel.
// let age4 = prompt("How old are you?",40); 
// alert(`You are ${age4} Years Old!`);

//confirm - Confirm show a model window with a Question and buttons:Ok / cancel.
            //The result is true if ok is pressed and false otherwise.
// let isBoss = confirm("Are you the BOSS?");
// alert("isBoss");            

                                                         // OPERATORS   (Lines : 90-253)
...
/*1.Arithmetic Operators:
       It is used to perform standard arithmetic operators and returns a single numerical value.
                               + - Addition
                               - - Substaction
                               * - Multiplication
                               / - Divison
...
let humamAge=35;
if(humamAge<6 || humamAge>=65){ // 76>=65
...
for (let i = 0; i <= 10; i++) {
    if(i%2 !==0) { //even and odd number code
...
//constructor
function Lect(name, age,dpmt) {    //pascal->MyFirstName
    this.name = name;
    this.age = age;
    this.dpmt = dpmt;
}
...
let he = {
    ...
    greeting: function () {
        let msg = `my name is ${this.name},i love ${this.interest}`;//this - is that object
        console.log(msg);
    }
}
he.greeting();
...
//factory functions
function createPerson(name, age) {   //camelcase =>myFirstName
    return {
        name,
        age,
        greeting() {
...
function She(name, age) {    //pascal->MyFirstName
    this.name = name;
    this.age = age;
...
function updatecard(card) {  //local scope
    cart.value++;
}
updatecard(cart);
...
for (let entries of Object.entries(user))
    console.log(entries);//key and values
...
console.log(month, date, year);
                                                 ...
                                                 //ARRAY METHODS IM JAVASCRIPT(396-725)
...
color3.splice(0,0, 'white', 'orange', 'pink')
console.log(color3);
...
console.log(color5.includes('blue'));
                                                ...
                                                //11.JS Array .find() and 12.Js Array.findIndex() 
...
let search = vegetables.find((vegetable) => {  //callback function
    return vegetable.item === 'carrot'
})
console.log(search);

                                                 /*  ARROW FUNCTION => ES6
                                 Arrow functinon allow us to write shorter function syntax.
                                 Arrow function make your code more readable and structured.  
introduced in the ES6 version of javascript. They provide us with a new and shorter syntax for declaring functions.
Arrow functions can only be used as a function expression. */
let expression = function (a,b) { //anonomyous Function
    return a* b ;
}
...
//References Type
const shopping_cart1 = [{ item: 'mango' },
                        { item: 'stabery'}];
...
const studentName = [
    ...
    { id: 5, name: 'Muthu' },
    { id: 7, name: 'venkat' }];
studentName.sort((a, b) => {   //ASCII - American Stansard Codefor Information Interchange TABLE 
...
let totalPrice = vegeTable.reduce((previousval, currentval) => previousval + currentval.price, 20);
...
console.log(total);
//find()
let total1 = numBer.find((val) => val > 30);//Single(only one)value o/p
console.log(total1);
//filter()
let total2 = numBer.filter((val) => val > 30);//all value o/p
console.log(total2);
//map()
...
console.log('charCodeAt 4 : '+c); //ASII VALUE
...
playvideo.call({videotitle : "javascript"});
...
// accessing outerfunction name variable 
 ...
 console.log(innerfunction); // return the funcrtoon definition
 ...
 function factorial(input) {
    if (input <= 0){  // 5 lessthan equal to 0
        return null;
    }else {
        ans =1;
